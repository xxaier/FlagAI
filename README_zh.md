...
```
- [可选] 开启 BMTrain 训练，需要安装 [BMTrain](https://github.com/OpenBMB/BMTrain)
```
...
AltCLIP 请参见 [AltCLIP 的 ONNX 模型导出](./onnx/README.md)
...
FlagAI 飞智大部分项目基于 [Apache 2.0 license](LICENSE)，但是请注意部分项目代码基于其他协议：
